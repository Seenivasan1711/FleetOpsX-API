...
from app.api.v1 import (
    ...
    audit, governance, scenarios, ws, public_track, user_mgmt, conversations,
)
...
api_router.include_router(conversations.router, prefix="/api/v1")  # MongoDB chat conversations (P6)
