...
def analytics_kpis(
    ...
    return get_kpis(db=db, tenant_id=tenant_id, since=since, until=until)
...
def driver_performance(
    ...
    return get_driver_performance(db=db, tenant_id=tenant_id, since=since)
...
def kpi_trend(
    ...
    return get_kpi_trend(db=db, tenant_id=tenant_id, days=days)
...
def trigger_etl(
    ...
    result = run_etl(db=db, tenant_id=tenant_id, etl_date=plan_date)
